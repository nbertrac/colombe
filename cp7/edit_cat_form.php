...
<body class="container">
    ...
    <form action="edit_cat_proc.php<?php echo ($_SERVER['QUERY_STRING'] ? '?' . $_SERVER['QUERY_STRING'] : ''); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="NOM_CATEGORIE" id="NOM_CATEGORIE" class="form-control" pattern="[A-Za-z\u00c0-\u00FF '\-]{1,25}" value="<?php echo (!empty($row)) ? $row['NOM_CATEGORIE'] : ''; ?>" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="file" name="PHOTO" id="PHOTO" class="form-control" accept=".gif,.jpg,.jpeg,.png,.webp" value="">
            <input type="hidden" name="MAX_FILE_SIZE" value="512000">
            <input type="hidden" name="tf" value="<?php echo (!empty($row)) ? $row['PHOTO'] : ''; ?>">
        </div>
